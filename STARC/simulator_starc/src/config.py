...
def make_model_config(name, dtype):
    ...
    model_table["Mistral-7B"]   = [32, 4096, 32, 128, 7/2, 4]   # 32 layers; 4096 hidden; GQA 8→32 (=4×) 
    model_table["DeepSeek-R1-7B"] = [28, 3584, 28, 128, 18944/3584, 7]  # 28 layers; 3584 hidden; GQA 4KV→28Q (=7×)
